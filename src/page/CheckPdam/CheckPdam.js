...
class CheckPdam extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    pdamCheck = () => {
        if (this.state.memberNum === "") {
            ...
            BankServices.getBillPdam(modelBill)
                .then(res =>{this.setState({memberNum : res.data});
                    this.props.navigation.navigate("PayPdam", {bankAccount: this.state.bankAccount, 
                    memberNum: this.state.memberNum})
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.containerTitle}>
                    ...
                    <View style={styles.TeksTitle}>
                        <Text style={styles.TeksTeks}>PDAM Payment Check</Text>
                    </View>
                </View>
                ...
                <View style={styles.containerFiller}>
                    <View style={styles.containerInput}>
                        ...
                        <TextInput placeholder="Insert a Member Number" onChangeText={text=>this.setState({memberNum: text})}
                        style={styles.inputTeks}></TextInput>
                    </View>
                    <TouchableOpacity style={styles.fillerButton}  onPress={this.pdamCheck}>
