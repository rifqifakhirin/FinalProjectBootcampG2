...
class PayBpjs extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.containerTitle}>
                    ...
                    <View style={styles.TeksTitle}>
                        <Text style={styles.TeksTeks}>BPJS Payment Transaction</Text>
                    </View>
                </View>
                <View style={styles.containerFiller}>
                    ...
                    <Text style={styles.detailInput}>ID Number :</Text>
                    <View style={styles.containerInput2}>
                        <View style={styles.inputIcon2}>
